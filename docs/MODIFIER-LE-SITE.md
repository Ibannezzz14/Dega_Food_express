...
| Photos brutes à retravailler | `Photos à retoucher/` |
| Photos visibles sur le site | `public/images/` |
| Photos sources et archives non publiées | `assets/source-images/` — archive locale ignorée par Git |
| Pages du site | `app/` |
...
Lucens et leurs alentours. Il peut aussi recevoir les demandes traiteur.
Ne pas créer un second contact de livraison. `CATERING_PHONE` reste le contact
dédié au formulaire de devis traiteur. Les deux numéros restent affichés à la
fin de la page traiteur.
...
Photos à retoucher/      prises brutes locales à retravailler
assets/source-images/    originaux locaux non publiés et ignorés par Git
...
- le numéro de commande, livraison et traiteur `076 603 60 11` ;
- l’autre numéro du service traiteur `078 265 40 81` ;

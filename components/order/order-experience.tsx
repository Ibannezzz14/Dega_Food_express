...
export default function OrderExperience({
  ...
  const {
    ...
    quantities,
    region: storedRegion,
    setFulfillmentMethod: setStoredFulfillmentMethod,
    setPaymentMethod,
    setQuantities,
  } = useOrderSession();
  const [fulfillmentMethod, setFulfillmentMethod] =
    useState<FulfillmentMethod | null>(
  ...
  function changeFulfillmentMethod(value: FulfillmentMethod) {
    setStoredFulfillmentMethod(value);
      ...
      >
        <div className={styles.menuPageCopy}>
          ...
          <p className={styles.menuPageIntroText}>
            Choisissez vos plats et votre mode de remise, puis continuez sur
            WhatsApp.
          </p>
        </div>

...
| Attiéké tilapia | Plats | Attiéké et tilapia clairement identifiables | Un condiment, petite garniture | Poisson d’espèce inconnue, soupe dominante, main | `/images/menu/attieke-poisson.webp` | `/images/menu/attieke-tilapia.webp` | Afimaame, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Attieke%2C_Tilapia_and_Light_soup.jpg), CC BY-SA 4.0 | **Validée** : espèce attestée ; recadrage sans main, tilapia et attiéké majoritaires | Non |
...
| Déguée | Desserts | Déguée de mil et lait/yaourt très majoritaire | Quelques raisins et une touche de cannelle | Autre dessert ou boisson visible | `/images/menu/degue.webp` | `/images/menu/deguee-proprietaire.webp` | Fichier fourni, métadonnées C2PA `gpt-image` | **Fournie / affichée** : le déguée occupe la grande majorité de l’image, sans personne | Confirmer que la garniture correspond à la recette vendue |
...
de toutes les pages. La photographie éditoriale principale montre désormais le
plat exact **alloco tilapia**. Les petites compositions réutilisent seulement
des visuels de produits validés : beignets, placali et bissap.
...
- 0 prix, volume ou catégorie modifié ; « Eau plate » a été précisé en
  « Eau Evian » et « Alloco tilapia » en « Alloco poisson braisé » à la
